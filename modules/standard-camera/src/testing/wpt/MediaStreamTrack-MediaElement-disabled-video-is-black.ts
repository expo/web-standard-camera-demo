// @ts-nocheck
// @ref LLP 0010 — Verbatim port of wpt/mediacapture-streams/MediaStreamTrack-MediaElement-disabled-video-is-black.https.html
// Original: https://github.com/web-platform-tests/wpt/blob/master/mediacapture-streams/MediaStreamTrack-MediaElement-disabled-video-is-black.https.html

import { wptSource, test, assert_equals, promise_test, setMediaPermission } from '../testharness';

wptSource('MediaStreamTrack-MediaElement-disabled-video-is-black.https.html');
...
// === END WPT BODY ===
  ...
  test(() => { throw __wptModuleLoadError; }, 'MediaStreamTrack-MediaElement-disabled-video-is-black.https.html — module load failed');
}
