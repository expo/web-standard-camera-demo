// @ts-nocheck
// @ref LLP 0007 — Verbatim port of wpt/mediacapture-streams/MediaStreamTrack-getCapabilities.https.html
...
import { wptSource, test, assert_equals, assert_in_array, assert_inherits, assert_less_than_equal, assert_true, promise_test, setMediaPermission } from '../testharness';
