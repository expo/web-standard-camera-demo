// @ts-nocheck
// @ref LLP 0007 — Verbatim port of wpt/mediacapture-streams/BrowserCaptureMediaStreamTrack-restrictTo.https.html
// Original: https://github.com/web-platform-tests/wpt/blob/master/mediacapture-streams/BrowserCaptureMediaStreamTrack-restrictTo.https.html

import { wptSource, test, assert_equals, assert_true, promise_test } from '../testharness';

wptSource('BrowserCaptureMediaStreamTrack-restrictTo.https.html');
...
// === END WPT BODY ===
  ...
  test(() => { throw __wptModuleLoadError; }, 'BrowserCaptureMediaStreamTrack-restrictTo.https.html — module load failed');
}
