// @ts-nocheck
// @ref LLP 0010 — Verbatim port of wpt/mediacapture-streams/MediaStream-MediaElement-srcObject.https.html
...
import { wptSource, test, assert_between_exclusive, assert_between_inclusive, assert_equals, assert_false, assert_greater_than, assert_greater_than_equal, assert_true, assert_unreached, promise_test, setMediaPermission } from '../testharness';

wptSource('MediaStream-MediaElement-srcObject.https.html');
...
// === END WPT BODY ===
  ...
  test(() => { throw __wptModuleLoadError; }, 'MediaStream-MediaElement-srcObject.https.html — module load failed');
}
